import { DataTableConfig } from '@/app/lib/data-table'
import type { ColumnSort, RowData } from '@tanstack/react-table'

export * from '@/app/hooks/use-data-table'
export * from '@/app/lib/data-table'
...
declare module '@tanstack/react-table' {
   // eslint-disable-next-line @typescript-eslint/no-unused-vars -- must have identical type parameters
